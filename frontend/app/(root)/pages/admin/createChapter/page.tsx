  ...
  return (
    <div className="max-w-4xl mx-auto mt-10 p-6 bg-white shadow-lg rounded-lg">
      ...
      <div className="mb-6 p-4 bg-blue-50 rounded-md">
        ...
        <h2 className="text-xl font-semibold mb-2 text-blue-800">Conseils pour un bon chapitre</h2>
        <ul className="list-disc pl-5 text-blue-700">
          ...
          <li>Relisez votre chapitre pour corriger les fautes d'orthographe</li>
          <li>Assurez-vous que le chapitre szz'intègre bien dans l'histoire globale</li>
        </ul>
      </div>
      ...
      {showTips && (
        <div className="mt-6 p-4 bg-yellow-50 rounded-md">
          <h3 className="text-lg font-semibold mb-2 text-yellow-800">Astuces d'écriture</h3>
          <ul className="list-disc pl-5 text-yellow-700">
            <li>Commencez par une accroche forte pour captiver le lecteur</li>
            <li>Utilisez des descriptions vivantes pour immerger le lecteur dans la scène</li>
            <li>Variez la longueur de vos phrases pour créer un rythme intéressant</li>
            <li>Terminez le chapitre sur un cliffhanger pour donner envie de lire la suite</li>
          </ul>
        </div>
      )}
